...
| [`research/44_postgres_projection_checkpoint_implementation.md`](research/44_postgres_projection_checkpoint_implementation.md) | 当前 W2 本地增量：`local_pending`，`9482790` | PostgreSQL 0008 durable projection checkpoint 表/SECURITY DEFINER CAS 函数、runtime-only authority、重启读回、stale conflict、公开错误映射与 PG18.6 集成证据；尚未关闭 inbox-outbox/dead-letter/commit-unknown/provider/备份与 result authority 门禁 |
