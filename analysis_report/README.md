...
| `research/16_event_store_process_binding_implementation.md` | 待独立复核的实现候选 | `SQLiteEventStore` 全入口 process binding、exact SQL snapshot、owner-aware transaction/migration/constructor、clean error graph、deferred stream 和 fork/spawn/forkserver fresh CAS；Gate A–E 保持关闭 |
