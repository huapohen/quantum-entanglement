...
- descriptor-based plan/approval file trust、Ed25519 domain separation、exact plan/identity/reference binding、
  deployment/cell namespace、key generation/fingerprint/policy revision 和 bounded approval window；
