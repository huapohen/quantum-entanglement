...
compatibility rollback guard，并复跑隔离
...
partial-write 注入与恢复处置见 [`research/75_projector_partial_write_fault_runbook_20260831.md`](../../analysis_report/research/75_projector_partial_write_fault_runbook_20260831.md)。
