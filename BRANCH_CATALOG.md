...
远端当前共有 **146** 个分支引用：1 个正式主线、96 个历史开发/证据候选、49 个只读取证归档。`archive/*` 中有不少只是同一历史节点的保险副本，并不代表同时维护的产品版本。
...
| 存在、干净 | `mainline_continue_quantum_entanglement` | `6a68b96a711b` | `/Users/lwblx/huapohen/agent/execute/infinite/worktrees/quantum_entanglement/mainline_continue_quantum_entanglement` |
